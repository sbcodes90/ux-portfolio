        ...
        <>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="text-white font-light lg:text-xl mx-10 lg:mx-72 my-10 text-center">
                        A mobile and desktop application designed to provide a easy and smoothe user experience, to educate users on political candidates, upcoming elections, and keep track of their favorite candidates.          </div>
                </div>
                ...
                <section className="items-start mx-10 lg:mx-60 px-12 py-14 bg-white shadow-2xl rounded-3xl mb-10">
                    ...
                    <div className="pb-5 font-light">Grow With Google X Mentor Me Collective</div>
